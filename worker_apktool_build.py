    ...
    try:
        ...
        if ks_info:
            ...
            if sign_proc.returncode == 0:
                ...
                CUSTOM_KEY_ERROR = CUSTOM_KEY_ERROR or f"apksigner rejected the custom key: {out.decode(errors='replace')[:200]}"
                edit("⚠️ Custom key rejected by apksigner. Falling back to debug key...")
                ks_success = False
